    ...
    return (
        <div className="lg:flex md:flex flex-row lg:space-x-3 justify-between">
            <div className="lg:w-[50%] md:[45%] md:ml-4 ml-3">
                <img className="lg:w-[500px] md: w-[297px] my-6 " src="/src/assets/categories-logo-img.png" alt="" />
            ...
            <div className="md:ml-4 ml-3 my-6 lg:w[50%] md:w-[42%] grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1">
                <div>
                    <img className="w[85%]" src="/src/assets/event-org-img1.png" alt="" />
                    <h1 className="text-xl text-slate-800  text-center font-medium">
                        Alisha Rees
                    </h1>
                </div>
                <div>
                    <img className="w[85%]" src="/src/assets/event-org-img2.png" alt="" />
                    <h1 className="text-xl text-center font-medium">
                    Rhys Carter
                    </h1>
                </div>
                <div>
                    <img className="w[85%]" src="/src/assets/event-org-img3.png" alt="" />
                    <h1 className="text-xl text-center font-medium">
                    Kyle Buckley
                    </h1>
                </div>
                <div>
                    <img className="w[85%]" src="/src/assets/event-org-img4.png" alt="" />
                    <h1 className="text-xl text-slate-800 text-center font-medium">
                    Maisie Walton
                    </h1>
                </div>
