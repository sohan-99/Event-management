            ...
            <div className="flex space-x-5 my-10">
                <div>
                    ...
                    <p className="text-xl font-medium">
                        ...
                        Ceremony & Reception, Entertainment,  Invitations, Registry,<br />Transportation & Accommodation, Hair & Makeup, Rehearsal Dinner, <br />
                        Marriage License, Wedding Day Timeline,Final Details, Emergency Kit,<br /> Relax & Enjoy.
                    </p>
                    <div className="stats bg-slate-400 shadow mt-36">
                ...
                <div className="w-[500px]">
                    <img className="w-[450px] h-[450]" src="https://i.ibb.co/m8FxyMM/817a781feaafd6ea2ba6d896f186c087.jpg" alt="" />
                </div>
            </div>
            {/* carusol */}
