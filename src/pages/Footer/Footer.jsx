    ...
    return (
        <div>
            <footer className="footer p-10 bg-indigo-600 text-neutral-content">
                <aside>
                   <img src="/src/assets/444.png" alt="" />
                    ...
                    to life with elegance, grace,<br /> and timeless 
                     ...
                     memories. Celebrate your love with Monaly.</p>
                </aside>
                <nav className="my-6">
                    <header className="font-bold text-2xl text-white">Social</header>
                    ...
                    <p className="text-white text-xl font-semibold">Copyright ©2023 monaly.com All Rights Reserved</p>
                </nav>
            </footer>
        </div>
    );
