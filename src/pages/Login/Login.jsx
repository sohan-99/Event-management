            ...
            <div className="mt-14 mb-9 flex flex-col items-center justify-center">
                <div className="bg-gray-300  lg:max-w-lg w-[80%] md:w-[85%] lg:w-[85%] p-8 rounded-lg shadow-lg">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <button onClick={handleGooglePopUp} className="bg-blue-500 hover:bg-blue-600 lg:text-xl font-semibold text-white py-3 px-6 rounded-full transition duration-300 w-full">
                            Google Login
                        </button>
